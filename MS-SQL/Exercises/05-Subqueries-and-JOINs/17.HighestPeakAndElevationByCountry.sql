...
) AS r ON p.CountryCode = r.CountryCode
WHERE p.DescendingElevationRank = 1 AND r.DescendingRiversLenghRank = 1 AND (p.Elevation IS NOT NULL OR r.Length IS NOT NULL)
